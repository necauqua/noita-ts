-- From https://github.com/probable-basilisk/pollnet/commit/b9361aabd82e568d7e0c6b00bbe991e3dc8c56bf
--  with minimal adjustment to use NoitaTS-specific path for ffi.load
